...
SELECT CUST_NAME,LOAN_AMOUNT,INT_RATE, CASE WHEN INT_RATE IS NULL THEN '0'
ELSE INT_RATE END FROM LOAN_ACCOUNTS;
SELECT CUST_NAME,LOAN_AMOUNT,INT_RATE, CASE WHEN INT_RATE IS NULL THEN 'No Interest'
ELSE INT_RATE END FROM LOAN_ACCOUNTS;
